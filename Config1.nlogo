...
to select-players
  ...
  ask player1 [
    set player2 one-of other players
  ]
end
...
to player1-win [value]
  ask player1 [
    set energy energy + value
  ]
end

to player2-win [value]
  ask player2 [
    set energy energy + value
  ]
end
...
; The color gradiant varies between green, full energy, and red, 1 energy.
...
375
323
Probabilistic transition between the states \"Cooperate\" and \"Defect\"\nTo complete the following datas, please refer to Chapter 3 Slide 34
11
0.0
1
